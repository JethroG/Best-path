...
class ApiClient {
  ...
  Future<ProcessDataStatusResponse> sendsFieldsData(
      String url, List<ProcessFiledData> processFiledData) async {
    final jsonString =
        jsonEncode(processFiledData.map((e) => e.toJson()).toList());
